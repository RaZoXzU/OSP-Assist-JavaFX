...
public class MemberOld {
    ...
    //for test only
    public MemberOld(String firstName, String surname, String city, Integer phoneNumber,
    ...
    public MemberOld(Integer id, String firstName, String surname, String fatherName,
